...
import {AddressPacketSchema, AddressPacketPayload} from './packet.interface';
import {PROTOCOL_VERSION} from '../constants';
import {OP_CODE} from './constants';

export class AddressPacket extends ArtNetPacket<AddressPacketPayload, AddressPacketSchema> {
  //order of schema fields makes sense do not change it!!!
  static readonly schema: AddressPacketSchema = {
