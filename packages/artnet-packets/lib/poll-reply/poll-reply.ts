...
export class PollReply extends ArtNetPacket<PollReplyPacketPayload> {
  ...
  static schemaDefault = new Schema([
    ...
    ['port', { size: 2, type: 'number', byteOrder: 'LE' }],
    ['firmwareVersion', { size: 2, type: 'number', byteOrder: 'BE' }],
    ['netSwitch', { size: 1, type: 'number' }],
    ['netSubSwitch', { size: 1, type: 'number' }],
    ['oem', { size: 2, type: 'number', byteOrder: 'BE' }],
    ['ubeaVersion', { size: 1, type: 'number' }],
    ['status1', { size: 1, type: 'number' }],
    ['estaManufactorerCode', { size: 2, type: 'number', byteOrder: 'BE' }],
    ['shortName', { length: 18, size: 1, type: 'string', encoding: 'utf8' }],
    ['longName', { length: 64, size: 1, type: 'string', encoding: 'utf8' }],
    ['nodeReport', { length: 64, size: 1, type: 'string', encoding: 'utf8' }],
    ['numPorts', { size: 2, type: 'number', byteOrder: 'BE' }],
    ...
    ['acnPriority', { size: 1, type: 'number' }],
    ['swMacro', { size: 1, type: 'number' }],
    ['swRemote', { size: 1, type: 'number' }],
    ['spare', { length: 3, type: 'array', size: 1 }],
    ['style', { size: 1, type: 'number' }],
    ['macAddress', { length: 6, type: 'array', size: 1 }],
    ['bindIp', { length: 4, type: 'array', size: 1 }],
    ['bindIndex', { size: 1, type: 'number' }],
    ['status2', { size: 1, type: 'number' }],
    ['goodOutputB', { size: 1, type: 'number' }],
    ['status3', { size: 1, type: 'number' }],
